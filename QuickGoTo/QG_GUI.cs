...
namespace QuickGoTo {
	...
	public partial class QGoTo {
		...
		string VAB_TexturePath = relativePath + "/Textures/StockVAB";
		string TS_TexturePath = relativePath + "/Textures/StockTS";
		string SPH_TexturePath = relativePath + "/Textures/StockSPH";
		string Sett_TexturePath = relativePath + "/Textures/StockSett";
		string SC_TexturePath = relativePath + "/Textures/StockSC";
		string RvSC_TexturePath = relativePath + "/Textures/StockRvSC";
		string RvED_TexturePath = relativePath + "/Textures/StockRvED";
		string Rv_TexturePath = relativePath + "/Textures/StockRv";
		string RnD_TexturePath = relativePath + "/Textures/StockRnD";
		string Rc_TexturePath = relativePath + "/Textures/StockRc";
		string MI_TexturePath = relativePath + "/Textures/StockMI";
		string Main_TexturePath = relativePath + "/Textures/StockMain";
		string Lves_TexturePath = relativePath + "/Textures/StockLves";
		string Astr_TexturePath = relativePath + "/Textures/StockAstr";
		string Admi_TexturePath = relativePath + "/Textures/StockAdmi";
		string Conf_TexturePath = relativePath + "/Textures/StockConf";
