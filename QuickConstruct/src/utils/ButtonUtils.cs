...
namespace QuickConstruct.utils
{
    public static class ButtonUtils
    {
        ...
        public static Button CreateConstructionButton(Button toClone, UnityAction onClick)
        {
            ...
            obj.GetComponent<TooltipController_Text>().textString = ConstructScenario.Instance.CanConstruct() ? "Start a construction" : "To many constructions.<br/>The storage is full.";
        ...
        public static void RefreshButton(ShipTemplate shipTemplate, Selectable launchBtn, Selectable constructBtn)
        {
            ...
            if (ConstructScenario.Instance.CanConstruct())
            {
                constructBtn.Unlock();
            }
            else
