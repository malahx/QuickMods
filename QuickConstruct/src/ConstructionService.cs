    ...
    public class ConstructionService
    {
        ...
        public void RemoveShipConstructionFromAlarm(uint alarmId, bool actioned)
        {
            ...
            foreach (var vessel in vessels)
            {
                ...
                Debug.Log($"[QuickConstruct](ConstructionService): {message} (from alarm removed)");
                break;
            }
        }
        ...
        public void CleanedConstruction(Dictionary<ShipTemplate, VesselListItem>.KeyCollection keys)
        {
            ...
            foreach (var vessel in vessels)
            {
                ...
                Debug.Log(
                    $"[QuickConstruct](ConstructionService): Deleted construction of {vessel.Name} in {vesselNames}");
            }
        }
