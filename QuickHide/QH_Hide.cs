    ...
    public partial class QHide
    {
        ...
        internal void DrawAppLauncherButtons()
        {
            ...
            for (int _i = ModsToolbar.Count - 1; _i >= 0; --_i)
            {
                ...
                _CanBePin = GUILayout.Toggle(_CanBePin, Localizer.Format("quickhide_pin"), GUILayout.Width(400));
                ...
                GUI.enabled = _CanBeHide;
                bool _CanSetFalse = _qMods.CanSetFalse;
                GUILayout.FlexibleSpace();
                _CanSetFalse = GUILayout.Toggle(_CanSetFalse, Localizer.Format("quickhide_setFalse"), GUILayout.Width(300));
                GUI.enabled = true;
